...
<div style="display: flex; align-items: center;">
  ...
  <div style="margin-left: 20px;">
    <h2>블록체인을 활용한 API 통합·중개 서비스</h2>
    <p>SSAFY 특화프로젝트 - 블록체인 P2P</p>
    <p>📅 2023.08.21 ~ 2023.10.06</p>
  </div>
</div>
...
<span style="font-size:20px">- API 사용에 따른 개발 시간 단축의 필요</span>
...
> <strong style="font-size:20px">사용자</strong>
...
> <strong style="font-size:20px">제공자</strong>
...
> <strong style="font-size:20px">관리자</strong>
...
|   <center>양시온</center>   |  <center>문지은</center>   |  <center>박서희</center>   | <center>송아람</center> | <center>이도하</center> | <center>이찬웅</center> |
| :-------------------------: | :------------------------: | :------------------------: | :---------------------: | :---------------------: | :---------------------: |
